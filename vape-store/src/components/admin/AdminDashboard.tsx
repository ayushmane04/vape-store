...
export default function AdminDashboard() {
  ...
  const statsCards = [
    { title: 'Total Products', value: stats.totalProducts, color: 'bg-blue-500' },
    { title: 'Total Orders', value: stats.totalOrders, color: 'bg-green-500' },
    { title: 'Total Revenue', value: `₹${stats.totalRevenue.toLocaleString()}`, color: 'bg-purple-500' },
    { title: 'Low Stock Items', value: stats.lowStock, color: 'bg-red-500' },
  ]
    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={() => window.location.href = '/admin?tab=orders'}
